...
public class CartController {
    ...
    public ResponseEntity<MessageResponse> clearCart(@AuthenticationPrincipal User currentUser) {
        cartService.clearCart(currentUser.getId_user(), currentUser);
        return ResponseEntity.ok(new MessageResponse("Carrito vaciado correctamente."));
    }
}
